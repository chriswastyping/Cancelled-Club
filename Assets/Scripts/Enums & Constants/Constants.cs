...
public static class Constants
{
    ...
    public static List<Card> Cards = new List<Card>
    {
        ...
        new Card(JokeTypesEnum.ProgrammerJokes, "There are 10 kinds of people in the worls, those who understand binary and those who don't"),
        ...
        new Card(JokeTypesEnum.ProgrammerJokes, "My mind is llike an internet browser...19 tabs open, 3 of them are frozen, ads popping up everywhere, and I have no idea where the music is coming from"),
        ...
        new Card(JokeTypesEnum.CountryJokes, "Whatdoes the Loch Ness monster eat?  Fish and ships"),
        ...
        new Card(JokeTypesEnum.CountryJokes, "I have a Russion friend who's a sound technician.  And a Czech one too...a Czech one too"),
        ...
        new Card(JokeTypesEnum.CountryJokes, "Why do pipers walk while htey play?  To escape the noise"),
        ...
        new Card(JokeTypesEnum.ReligiousJokes, "I got divorced for religious reasons. My husband thought he was God; I diagreed "),
        ...
        new Card(JokeTypesEnum.WittyJokes, "What do cats eat on a hot day?  A mice-cream cone"),
        ...
        new Card(JokeTypesEnum.WittyJokes, "What do cats love to do in the morning?  Read the mewspaper "),
        ...
        new Card(JokeTypesEnum.WittyJokes, "What do cats like best for breakfast?  Mice Krispies "),
